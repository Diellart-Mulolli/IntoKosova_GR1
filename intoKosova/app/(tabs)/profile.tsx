    ...
    <View style={[styles.modal, { maxHeight: "90%" }]}>
      <ScrollView contentContainerStyle={{ paddingBottom: 20 }}
        ...
        <View style={styles.modalBtns}>
          ...
          >
            <Text style={{ fontWeight: "600", alignItems: "center", fontSize: 30, color: palette.text }}>Cancel</Text>
          </Pressable>

          <Pressable style={[styles.saveBtn, styles.addBtnStyle]} onPress={editingPhoto ? saveEdit : addCardWithoutImage}>
            <Text style={styles.saveText}>{editingPhoto ? "Save" : "Add"}</Text>
          </Pressable>
          ...
          {editingPhoto && (
            ...
            >
              <Text style={{ color: "#fff", fontWeight: "600", fontSize: 20, paddingTop: 1, paddingBottom: 10, borderColor: "white" }}>Delete</Text>
            </Pressable>
          )}
        </View>
      </ScrollView>
